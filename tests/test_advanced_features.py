...
from utils.session_pool import SessionPool, Session
from utils.http_client import HttpClient
from core.semantic_selectors import extract_semantic_fallback_images, extract_semantic_fallback_videos
...
def test_self_healing_semantic_selectors():
    ...
    fallback_images = extract_semantic_fallback_images(soup, "https://example.com/gallery", "Title")
    fallback_videos = extract_semantic_fallback_videos(soup, "https://example.com/gallery", "Title")
