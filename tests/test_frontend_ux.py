...
def test_ux_flow_transitions(mock_media_folder, page_session):
    ...
    page_session.wait_for_selector(f".sidebar-item[data-subject='{mock_media_folder}']", timeout=15000)
...
def test_ux_e2e_scraping_and_terminal(mock_popen, page_session):
    ...
    page_session.wait_for_selector("#live-terminal-body .terminal-line", timeout=20000)
