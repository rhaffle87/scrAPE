# scrAPE Operating Manual

This document provides unified project-scoped instructions, architectural guidelines, coding standards, and operational workflows for operators working in the **scrAPE** workspace.
